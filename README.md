...
* Ekundayo Pelumi <[Chrispel5](https://github.com/Chrispel5)>
* Salwa Olonade <[salwakhafeelheart](https://github.com/salwakhafeelheart)>
...
This project was done as ALX Africa curriculum. ALX Africa SE course is a full-stack software engineering program that prepares students for careers in the tech industry using project-based peer learning. For more information, visit (https://www.alxafrica.com/).
